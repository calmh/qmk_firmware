...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox(
      KC_ESCAPE,  KC_1,     KC_2,     KC_3,     KC_4,   KC_5,   TT(1),
      KC_TAB,     KC_Q,     KC_W,     KC_E,     KC_R,   KC_T,   LGUI(KC_SPACE),
      KC_LGUI,    KC_A,     KC_S,     KC_D,     KC_F,   KC_G,
      KC_LSHIFT,  KC_Z,     KC_X,     KC_C,     KC_V,   KC_B,   KC_MEDIA_NEXT_TRACK,
      ...
      KC_AUDIO_VOL_UP,    KC_Y,         KC_U,         KC_I,       KC_O,     KC_P,       KC_EQUAL,
                          KC_H,         KC_J,         KC_K,       KC_L,     KC_SCOLON,  KC_QUOTE,
      KC_AUDIO_VOL_DOWN,  KC_N,         KC_M,         KC_COMMA,   KC_DOT,   KC_SLASH,   KC_RSHIFT,
