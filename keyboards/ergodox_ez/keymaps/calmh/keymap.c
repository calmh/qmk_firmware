...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox(
      ...
      KC_LSHIFT,  KC_Z,     KC_X,     KC_C,     KC_V,   KC_B,   KC_LOCK,
      KC_LCTL,    KC_LALT,  KC_LGUI,  TT(1),    TT(2),

                                KC_DELETE,  LALT(KC_SCOLON), // å
                                            LALT(KC_LBRACKET), // ä
                    KC_SPACE,   KC_BSPACE,  LALT(KC_RBRACKET), // ö


      KC_END,         KC_6,         KC_7,         KC_8,       KC_9,     KC_0,       KC_MINUS,
      KC_LBRACKET,    KC_Y,         KC_U,         KC_I,       KC_O,     KC_P,       KC_EQUAL,
                      KC_H,         KC_J,         KC_K,       KC_L,     KC_SCOLON,  KC_QUOTE,
      KC_RBRACKET,    KC_N,         KC_M,         KC_COMMA,   KC_DOT,   KC_UP,      KC_RSHIFT,
                                    KC_SLASH,     KC_BSLASH,  KC_LEFT,  KC_DOWN,    KC_RIGHT,

                      LCMD(KC_LEFT),  LCMD(KC_RIGHT),
                      KC_PGUP,
                      KC_PGDOWN,  KC_RSHIFT, KC_ENTER
    ),
  ...
  [2] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                    ...
                    KC_AUDIO_VOL_UP,
                    KC_AUDIO_VOL_DOWN,    KC_AUDIO_MUTE, KC_MEDIA_PLAY_PAUSE
),
