...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
     ...
     KC_LCTL ,KC_LALT ,KC_LGUI ,MO(2)   ,    MO(1)   ,     KC_SPC , KC_BSPC ,        KC_ENT  ,KC_SPC  ,    MO(1)   ,     KC_BKSL ,KC_AA   ,KC_AE    ,KC_OE
  ),

  [1] = LAYOUT(
     _______ ,KC_F1   ,KC_F2   ,KC_F3   ,KC_F4   ,KC_F5   ,                                            KC_F6   ,KC_F7   ,KC_F8   ,KC_F9   ,KC_F10  ,_______ ,
     _______ ,KC_F11  ,KC_F12  ,KC_F13  ,KC_F14  ,KC_F15  ,_______ ,                          _______ ,RCMD(KC_LEFT) ,RCMD(KC_DOWN) ,RCMD(KC_UP) ,RCMD(KC_RIGHT) ,_______ ,_______ ,
