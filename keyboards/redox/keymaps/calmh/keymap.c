...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
     ...
     KC_TAB  ,KC_Q    ,KC_W    ,KC_E    ,KC_R    ,KC_T    ,KC_MENU ,                          KC_LGOU ,KC_Y    ,KC_U    ,KC_I    ,KC_O    ,KC_P     ,KC_EQL  ,
     ...
     KC_LCTL ,KC_LALT ,KC_LGUI ,MO(3)   ,    MO(2)   ,     KC_SPC , KC_BSPC ,        KC_ENT  ,KC_SPC  ,    MO(1)   ,     KC_BKSL ,KC_AA   ,KC_AE    ,KC_OE
  ),
  ...
  [2] = LAYOUT(
     ...
     _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,_______ ,                          _______ ,_______ ,KC_KP_4 ,KC_KP_5 ,KC_KP_6 ,KC_KP_MINUS ,_______ ,
     ...
     _______ ,_______ ,_______ ,_______ ,     _______ ,    _______ ,_______ ,        _______ ,_______ ,    _______ ,     KC_KP_0 ,_______ ,_______ ,_______
  ),

  [3] = LAYOUT(
     RESET   ,_______ ,_______ ,_______ ,_______ ,_______ ,                                            _______ ,_______ ,_______ ,_______ ,_______ ,UC_MOD  ,
